<footer>
    <div class="footer-body">
        ...
        <?php
            ...
            if($username)
            {
                ...
                echo "<a href='/ProjectThema4/pages/login.php?logout'>Logout</a>";
            }
            echo "<p>" . date("Y-m-d") . "</p>";
        ?>
        </div>
    ...
    <div class="footer-bottom">
        <p>&copy; 2021 <a href="https://markiesch.github.io/portfolio/" rel="noopener" target="_blank">Mark Schuurmans</a></p>
        <div>
